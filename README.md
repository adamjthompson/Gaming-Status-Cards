...
This plugin includes six unique cards to visualize your squad's gaming habits: a clean **List Card**, a dynamic CSS-animated **Slideshow Card**, a player-based **Weekly Hours Card**, a platform **Platforms Card**, a **Leaderboard Card**, and a game-based **Weekly Games Card**.
...
When you edit a dashboard and click **Add Card**, you will now see six new options at the bottom of your card picker.
